...
public class AdminView extends JFrame {
    ...
    public AdminView() throws HeadlessException {
        ...
        gbc.gridy = 0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        createPanel.add(employeeRadio, gbc);

        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        createPanel.add(adminRadio, gbc);
    ...
    private void initializeFields() {
        ...
        radioButtons.add(employeeRadio);
        ...
        Object[] headers = {"ID", "Username", "Password"};
    ...
    public void setDoDeleteListener(ActionListener l) {
        doDelete.addActionListener(l);
    }

    public void setDoEditListener(ActionListener l) {
        doEdit.addActionListener(l);
    }
    ...
    public String getEditPassText() {
        return editPassText.getText();
    }
    ...
    public boolean isEmployeeRadioSelected() {
        return employeeRadio.isSelected();
    }
